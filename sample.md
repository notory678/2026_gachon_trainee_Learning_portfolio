...
**실무 시나리오를 바탕으로, 수험자가 제약 조건 속에서 최적의 고가용성 아키텍처를 찾아낼 수 있는지 평가합니다.**
...
* **보류?:** * **①번(Multi-Region):** '고가용성'이라는 키워드만 보고 성급히 고르도록 유도하는 함정입니다. 지문의 '비용 제한'과 '최소 지연 시간' 조건을 어기므로 매우 매력적인 오답이 됩니다.
