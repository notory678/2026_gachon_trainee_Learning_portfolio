# Domain 1. Cloud Fundamentals - Region 및 Availability Zone(AZ)
<div align="left">
  <i>작성일자: 2026-04-09 | 작성자: 카카오클라우드 엑스퍼트 OOO</i>
</div>
...
### 🚨 오답 포인트 및 헷갈리기 쉬운 함정 (Distractor Check)
...
**[시나리오] E-commerce 웹 서비스의 고가용성 아키텍처 설계**
...
### 🌳 아키텍처 의사결정 트리 (Decision Tree)
*(아래 다이어그램은 깃허브 마크다운에서 자동으로 렌더링됩니다.)*
